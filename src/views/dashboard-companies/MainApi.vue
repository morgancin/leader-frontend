...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      ...
      <div class="text-center">
          <a href="javascript:;" @click="headerFooterModalPreview = true" class="btn btn-primary shadow-md mr-2">Add Company</a>
      </div>
      <!-- END: Modal Toggle -->
      <!-- BEGIN: Modal Content -->
          ...
          <ModalBody>
              ...
              <form @submit.prevent="addCompany" autocomplete="on">
                <div class="col-span-12 sm:col-span-6">
                  ...
                  <input id="company" v-model="name" type="text" class="form-control" placeholder="Company" />
              </div>
              <div class="col-span-12 sm:col-span-6">
                  <label for="email" class="form-label">email</label>
                  <input id="email" v-model="email" type="email" class="form-control" placeholder="example@gmail.com" />
              </div>
              <div class="col-span-12 sm:col-span-6">
              ...
              <div class="col-span-12 sm:col-span-6">
                  ...
                  <input id="conf_password" v-model="password_confirmation" type="password" class="form-control" placeholder="**********" />
              </div>
      ...
      <!-- END: Modal Content -->
      <!-- <router-link class="btn btn-primary shadow-md mr-2" :to="`/edit-user`">Edit Company</router-link> -->
...
const dataCompany = {
   ...
   company_name: 'Preuba S.A.de C.V.',
   postal_code: '09000', 
