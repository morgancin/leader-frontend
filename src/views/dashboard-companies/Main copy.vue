      ...
      <Modal :show="headerFooterModalPreview" @hidden="headerFooterModalPreview = false">
          ...
          <ModalBody class="grid grid-cols-12 gap-4 gap-y-3">
            <div class="col-span-12 sm:col-span-6">
                  <label for="modal-form-3" class="form-label">Company</label>
                  <input id="modal-form-3" type="text" class="form-control" placeholder="Company" />
              </div>
              <div class="col-span-12 sm:col-span-6">
              ...
              <div class="col-span-12 sm:col-span-6">
                  <label for="modal-form-1" class="form-label">Confirm Password</label>
                  <input id="modal-form-1" type="password" class="form-control" placeholder="**********" />
              </div>
              <!-- <div class="col-span-12 sm:col-span-6">
