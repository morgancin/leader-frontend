      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 mt-8">
          <div class="intro-y flex items-center h-10">
            <h2 class="text-lg font-medium truncate mr-5">Dashboard principal</h2>
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  ...
                  <div class="text-base text-slate-500 mt-1">Ventas</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
        ...
        <div class="col-span-12 mt-6">
          ...
          <div class="2xl:pl-6 grid grid-cols-12 gap-x-6 2xl:gap-x-0 gap-y-6 overflow-x-scroll">
            <!-- BEGIN: Pipeline -->
            <div
              class="col-span-4 md:col-span-6 xl:col-span-4 2xl:col-span-4 2xl:mt-8 mt-3 mr-3"
              v-for="stage in pipelineStages"
                  :key="stage.id"
            >
              <div class="intro-x flex items-center h-10">
                <h2 class="text-lg font-medium truncate mr-5">{{ stage.name }}</h2>
              </div>
              <div class="mt-5">
                <div
        ...
        <div class="2xl:pl-6 grid grid-cols-12 gap-x-6 2xl:gap-x-0 gap-y-6">
          ...
          >
            <div class="intro-x flex items-center h-10">
              ...
              <a href="" class="ml-auto text-primary truncate">Ver más</a>
            </div>
            <div
          ...
          >
            <div class="intro-x flex items-center h-10">
              <h2 class="text-lg font-medium truncate mr-5">Agenda</h2>
              <a
                href=""
