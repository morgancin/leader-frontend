<script setup>
  ...
  const initTabulator = () => {
    tabulator.value = new Tabulator(tableRef.value, {
      ajaxURL: "https://api.leader.arkanmedia.com/api/activities/subjects/list/1",
      ajaxConfig:{
        method:"GET",
        headers: {
      ...
      columns: [
        // For HTML table
        {
          title: t('list.catalogs_subjects.column_1'),
          minWidth: 200,
          field: "name",
          vertAlign: "middle",
          print: true,
        ...
        {
          title: t('list.catalogs_subjects.column_2'),
          minWidth: 200,
        ...
        {
          title: t('list.catalogs_subjects.column_3'),
          minWidth: 200,
          field: "actions",
          vertAlign: "middle",
          print: false,
          ...
          formatter(cell) {
            const a = dom(` <div class="flex items-center lg:justify-center">
                              <a class="flex items-center mr-3" href="/subjects/edit/${cell.getData().id}">
  ...
  const initTabulator = () => {
    tabulator.value = new Tabulator(tableRef.value, {
      ...
      ajaxURL: "https://api.leader.arkanmedia.com/api/activities/subjects/list",
      ajaxConfig:{
        method:"GET",
        headers: {
            "Authorization": `Bearer ${sessionStorage.getItem("TOKEN")}`,
...
<template>
   <div class="flex flex-col items-center mt-8 intro-y sm:flex-row">
    <h2 class="mr-auto text-lg font-medium">{{ $t('catalogs_subjects.list_subjects') }}</h2>
    <div class="flex w-full mt-4 sm:w-auto sm:mt-0">
      <router-link class="mr-2 shadow-md btn btn-primary" :to="`/add-subjects`">{{ $t('catalogs_subjects.btn_add_new_subjects') }}</router-link>
