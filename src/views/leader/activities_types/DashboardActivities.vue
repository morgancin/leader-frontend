  ...
  const initTabulator = () => {
    tabulator.value = new Tabulator(tableRef.value, {
      ...
      columns: [
        // For HTML table
        {
          title: t('list.catalogs_activities.column_1'),
          minWidth: 200,
          field: "name",
          vertAlign: "middle",
          print: true,
        ...
        {
          title: t('list.catalogs_activities.column_2'),
          minWidth: 200,
          field: "type",
          vertAlign: "middle",
          print: true,
        ...
        {
          title: t('list.catalogs_activities.column_3'),
          minWidth: 200,
          field: "actions",
          vertAlign: "middle",
          print: false,
          ...
          formatter(cell) {
            const a = dom(` <div class="flex items-center lg:justify-center">
                              <a class="flex items-center mr-3" href="/activities-types/edit/${cell.getData().id}">
