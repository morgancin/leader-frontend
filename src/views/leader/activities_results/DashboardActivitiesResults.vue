<script setup>
  ...
  const initTabulator = () => {
    tabulator.value = new Tabulator(tableRef.value, {
      ajaxURL: "https://api.leader.arkanmedia.com/api/activities/results/list",
      ajaxConfig:{
        method:"GET",
        headers: {
      ...
      columns: [
        // For HTML table
        {
          title: t('list.catalogs_activities_results.column_1'),
          minWidth: 200,
          field: "name",
          vertAlign: "middle",
          print: true,
        ...
        {
          title: t('list.catalogs_activities_results.column_3'),
          minWidth: 200,
          field: "actions",
          vertAlign: "middle",
          print: false,
          ...
          formatter(cell) {
            const a = dom(` <div class="flex items-center lg:justify-center">
                              <a class="flex items-center mr-3" href="/activities-results/edit/${cell.getData().id}">
