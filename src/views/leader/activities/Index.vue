  ...
  const initTabulator = () => {
    tabulator.value = new Tabulator(tableRef.value, {
      ...
      columns: [
        // For HTML table
        {
          title: t('activities.list.labels.actions_column'),
          minWidth: 200,
          field: "actions",
          vertAlign: "middle",
          print: false,
        ...
        {
          title: t('activities.list.labels.column_2'),
          minWidth: 200,
        ...
        {
          title: t('activities.list.labels.column_3'),
          minWidth: 200,
        ...
        {
          title: t('activities.list.labels.column_4'),
          minWidth: 200,
        ...
        {
          title: t('activities.list.labels.column_5'),
          minWidth: 200,
