<template>
  <div class="flex flex-col items-center mt-8 intro-y sm:flex-row">
    ...
    <div class="flex w-full mt-4 sm:w-auto sm:mt-0">
      <router-link class="mr-2 shadow-md btn btn-primary" :to="`/add-user`">{{ $t('users.buttons.new') }}</router-link>
  ...
  const initTabulator = () => {
    tabulator.value = new Tabulator(tableRef.value, {
      ...
      columns: [
        // For HTML table
        {
          title: t('users.list.labels.column_1'),
          minWidth: 200,
          field: "name",
          vertAlign: "middle",
          print: true,
        ...
        {
          title: t('users.list.labels.column_2'),
          minWidth: 200,
          field: "email",
          vertAlign: "middle",
          print: true,
        ...
        {
          title: t('users.list.labels.actions_column'),
          minWidth: 200,
          field: "actions",
          vertAlign: "middle",
          print: false,
          ...
          formatter(cell) {
            const a = dom(` <div class="flex items-center lg:justify-center">
                              <a class="flex items-center mr-3" href="/user/edit/${cell.getData().id}">
                                <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> ${ t('users.list.labels.actions.edit') }
                              </a>
                            </div>`);
