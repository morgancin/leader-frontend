<script setup>
  ...
  const initTabulator = () => {
    tabulator.value = new Tabulator(tableRef.value, {
      ...
      ajaxURL: "https://api.leader.arkanmedia.com/api/clients/origins/list",
      ajaxConfig:{
        method:"GET",
        headers: {
...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">{{ $t('catalogs_origins.list_origins') }}</h2>
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <router-link class="btn btn-primary shadow-md mr-2" :to="`/add-origin`">{{ $t('catalogs_origins.btn_add_new_origins') }}</router-link>
