<script setup>
  ...
  const initTabulator = () => {
    tabulator.value = new Tabulator(tableRef.value, {
      ajaxURL: `${import.meta.env.VITE_API_BASE}categories`,
      ajaxConfig:{
        method:"GET",
        headers: {
      ...
      columns: [
        // For HTML table
        {
          title: t('list.categories.column_1'),
          minWidth: 200,
          field: "name",
          vertAlign: "middle",
          print: true,
        ...
        {
          title: t('list.categories.column_2'),
          minWidth: 200,
          field: "actions",
          vertAlign: "middle",
          print: false,
          ...
          formatter(cell) {
            const a = dom(` <div class="flex items-center lg:justify-center">
                              <a class="flex items-center mr-3" href="/categories/edit/${cell.getData().id}">
...
<template>
  <div class="flex flex-col items-center mt-8 intro-y sm:flex-row">
    ...
    <div class="flex w-full mt-4 sm:w-auto sm:mt-0">
      <router-link class="mr-2 shadow-md btn btn-primary" :to="`/add-category`">{{ $t('add_categories.btn_add_new_category') }}</router-link>
