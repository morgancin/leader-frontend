<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">{{ $t('users.users') }}</h2>
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <router-link class="btn btn-primary shadow-md mr-2" :to="`/add-user`">{{ $t('users.btn-add-new-user') }}</router-link>
...
const initTabulator = () => {
  tabulator.value = new Tabulator(tableRef.value, {
    ...
    printAsHtml: true,
    printStyled: true,
    pagination: "local", // pagination: "remote",
    paginationSize: 5, // paginationSize: 10,
    paginationSizeSelector: [10, 20, 30, 40], // paginationSizeSelector: [10, 20, 30, 40],
    layout: "fitColumns",
