              ...
              <div class="form-label xl:w-72 xl:!mr-10">
                <div class="text-left">
                  <div class="flex items-center">
                    ...
                    <div class="mt-3 text-xs leading-relaxed text-slate-500">
                        If the status is active, your activity result can be searched for by
                        potential buyers.
                      </div>
                    </div>
                  </div>
                  <div class="flex-1 w-full mt-3 xl:mt-0">
                    <div class="form-check form-switch">
                      <input
                        ...
                        v-model="activity_result.is_tracking" />                        
                      <label class="form-check-label" for="product-status-active">is tracking</label>
                </div>
              </div>
            </div>
                  ...
                  <div class="flex-1 w-full mt-3 xl:mt-0">
                    <div class="form-check form-switch">
                      <input
                        ...
                        class="form-check-input"
                        id="product-status-active"
                        v-model="activity_result.active" />                        
