...
<script setup>
    ...
    import { useQuotesCarStore } from "../../../stores/leader/quotesCar";
    ...
    import { useGetDataPricesLists } from "../../../composables/getDatas/useGetDataPricesLists";

    const addItemModal = ref(false);
    const newOrderModal = ref(false);

    const { addProductCar } = useQuotesCarStore();
    const { car } = storeToRefs(useQuotesCarStore());
...
<template>
    ...
    <div class="grid grid-cols-12 gap-5 mt-5 intro-y">
      ...
      <div class="col-span-12 intro-y lg:col-span-8">
        <div class="col-span-12 intro-y sm:col-span-6 md:col-span-6">
          <label for="cmbPricesLists" class="form-label">{{ $t('add_prospect_details.place_of_birth') }}</label>
          <v-select
              id="cmbPricesLists"
              class="form-control"
        ...
        <div class="grid grid-cols-12 gap-5 mt-5">
          ...
          <div
            ...
            :key="id"
            @click="fetch_products_or_categories(category)"
          ...
          <div class="p-2 mt-5 box">
            <a
              ...
              class="flex items-center p-3 transition duration-300 ease-in-out bg-white rounded-md cursor-pointer dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400">
                ...
                <div class="ml-auto font-medium">$0.00</div>
            </a>
          </div>
    ...
    <Modal :show="addItemModal" @hidden="addItemModal = false">
      ...
      <ModalFooter class="text-right">
        ...
        <button type="button" class="w-24 btn btn-primary" @click="add_product(null)">Add Item</button>
      </ModalFooter>
    </Modal>
    <!-- END: Add Item Modal -->
