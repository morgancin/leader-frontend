            ...
            <form @submit.prevent="submitForm" autocomplete="on">
                <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                    ...
                    <!-- <div class="intro-y col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-3">
                        ...
                        <input type="text" class="form-control" :placeholder="$t('add_prospect_details.birth_date')"
                    ...
                    <!-- <div class="input-form intro-y col-span-12 sm:col-span-6 md:col-span-3">
                        ...
                        <v-select 
                            ...
                            v-model="prospect.client_origin"
                            v-model.trim="v$.client_origin.$model"
                            :class="{ 'border-danger': v$.client_origin.$error }">
                        </v-select>
                        <template v-if="v$.client_origin.$error">
                          <div
                            v-for="(error, index) in v$.client_origin.$errors"
                            :key="index"
                            class="text-danger mt-2">
                            {{ error.$message }}
                          </div>
